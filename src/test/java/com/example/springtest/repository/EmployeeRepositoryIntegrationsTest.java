...
public class EmployeeRepositoryIntegrationsTest {
    @Autowired
    ...
    public void givenEmployeeLists_whenFindAll_thenReturnEmployeesLists() {
        ...
        Employee actualEmployee2 = Employee.builder().firstName("Fourat").lastName("ben hassine")
                                           .email("fourat.azouzi@enis.tn").build();
    ...
    public void givenEmployeeObject_whenUpdateObject_thenReturnObjectUpdated() {
        ...
        assertAll("assert that all field are updated", () -> assertThat(updatedEmployee.getEmail()).isEqualTo(savedEmployee.getEmail()), () -> assertThat(updatedEmployee.getFirstName()).isEqualTo(savedEmployee.getFirstName()));
    ...
    public void givenEmployeeObject_whenFindByJQPL_thenReturnEmployeeWithFirstnameAndLastname() {
        ...
        assertAll("assert that employee have same first and last name", () -> assertThat(employee1.getFirstName()).isEqualTo(employee.getFirstName()), () -> assertThat(employee1.getLastName()).isEqualTo(employee.getLastName()));
    }
